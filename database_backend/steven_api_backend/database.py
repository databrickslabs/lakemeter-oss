...
def init_engine():
    ...
    try:
        ...
        instance_name = os.getenv("LAKEBASE_INSTANCE_NAME", "lakemeter-db")
        ...
        database_name = os.getenv("LAKEBASE_DATABASE_NAME", "lakemeter_pricing")
        username = (
        ...
        engine = create_async_engine(
            ...
            connect_args={
                ...
                "server_settings": {
                    "application_name": "lakemeter_api",
                },
                "ssl": "require",
            },
        )
