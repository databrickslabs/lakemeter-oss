...
table_stmts = [
    ...
    f"""CREATE TABLE IF NOT EXISTS {SCHEMA}.ref_workload_types (
        ...
        show_genie_config BOOLEAN DEFAULT false,
    ...
    f"""CREATE TABLE IF NOT EXISTS {SCHEMA}.line_items (
        ...
        genie_product VARCHAR(20),
        genie_size VARCHAR(10),
        genie_num_users INT,
        genie_dbus_per_user_per_month NUMERIC(12,2),
        genie_num_service_principals INT,
        genie_dbus_per_sp_per_month NUMERIC(12,2),
        genie_warehouse_size VARCHAR(20),
        genie_active_hours_per_month NUMERIC(12,2),
        genie_reuse_existing_warehouse BOOLEAN DEFAULT false,
        genie_apply_promo BOOLEAN DEFAULT true,
        genie_promo_pct NUMERIC(5,2) DEFAULT 25,
...
workload_seeds = [
    ("JOBS", "Jobs Compute", "Scheduled batch jobs (Classic or Serverless)",
     True, True, True, True, False, False, False, False, False, False, True, False, True, False, False, False,
    ...
    ("DLT", "Delta Live Tables", "Declarative ETL pipelines (Classic or Serverless)",
     True, True, True, True, True, False, False, False, False, False, True, True, False, False, False, False,
    ...
    ("VECTOR_SEARCH", "Vector Search", "Vector search endpoints for RAG",
     False, False, False, False, False, False, True, False, False, True, False, True, False, False, False, False,
    ...
    ("LAKEBASE", "Lakebase", "Managed PostgreSQL database for operational workloads",
     False, False, False, False, False, False, False, False, True, False, False, True, True, False, False, False,
     None, None, "DATABASE_SERVERLESS_COMPUTE", 9),
    ("GENIE", "Genie", "AI/BI Genie LLM usage (One/Spaces) — Paygo on the SRTI SKU",
     False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False,
     None, None, "SERVERLESS_REAL_TIME_INFERENCE", 10),
    ("GENIE_CODE", "Genie Code", "Genie Code agentic LLM usage — Paygo on the SRTI SKU",
     False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, False,
     None, None, "SERVERLESS_REAL_TIME_INFERENCE", 11),
    ("LAKEHOUSE_FEDERATION", "Lakehouse Federation", "Federated queries billed via Serverless SQL compute (no separate SKU)",
     False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, True,
     None, None, "SERVERLESS_SQL_COMPUTE", 12),
]
    ...
    cur.execute(
        f"""INSERT INTO {SCHEMA}.ref_workload_types
           (workload_type, display_name, description,
            ...
            show_usage_runs, show_usage_tokens, show_genie_config, show_federation_config,
...
# New workload-type config flags (for existing installs)
for flag_col in ("show_genie_config", "show_federation_config"):
    try:
        cur.execute(f"ALTER TABLE {SCHEMA}.ref_workload_types ADD COLUMN IF NOT EXISTS {flag_col} BOOLEAN DEFAULT false")
    except Exception:
        pass
